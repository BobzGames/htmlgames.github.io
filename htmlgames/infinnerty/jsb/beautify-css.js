...
function css_beautify(source_text, options) {
    ...
    var isStyleTag = (source_text && source_text.length > 6) && source_text.substring(0, 6).toLowerCase() === "<style";
    ...
    prnt.newLine = function(keepWhitespace) {
        if (!keepWhitespace)
    ...
    return (isStyleTag) ? sweetCode.replace(">",">\n").replace(">\n ",">\n") : sweetCode;
}
