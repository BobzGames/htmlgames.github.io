...
//
// (v0.235C) < insert random number here... C = Cloud variables / lists enabled
//
...
// PF end of New audio stuff ***
  ...
  var Cloud = function(stage) {
    ...
    this.ws = new WebSocket(location.protocol === 'https:' ? 'wss://' : 'ws://' + "phosphate.herokuapp.com" + '/cloud/' + stage.id);
