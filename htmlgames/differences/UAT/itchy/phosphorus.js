...
//
// (v0.293) < insert random number here...
//
...
// PF end of New audio stuff ***
  ...
  Stage.prototype.showList = function(name) {
	...
	if (o_list.length) {
	  divItem2.innerHTML = "<div style='font-size: 11em; text-align: center; bottom: 3px; position: absolute; width: 100%;'>" +  "length: " + o_list.length + "</div>";
	} else {
