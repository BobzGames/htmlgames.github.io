// additional bugfixes by PF (v0.325) < insert random number here...
// 
...
// PF end of New audio stuff ***
  ...
  Base.prototype.addLists = function(lists) {
    for (var i = 0; i < lists.length; i++) {
      ...
      this.lists[lists[i].x] = lists[i].width;
      this.lists[lists[i].y] = lists[i].height;
      this.lists[lists[i].x] = lists[i].visible;
    }
  };
