...
// PF end of New audio stuff ***
  ...
  Stage.prototype.showList = function(name) {
	...
	for (var i = 0; i < o_list.length; i++) { // test
	  ...
	  divItem.innerHTML = "<input readonly value=' " + (i + 1) + "' style='color: #000; border: 0; background-color: #c1c4c7; width: 10%; font-size: 11px; margin: 1px'/> <input readonly value='" + o_list[i] + "' style='font-size: 12px; background-color: #cc5b22; color: white; width: 77%; height: 12px; border: 1px solid #fff; border-radius: 3px; padding: 3px; margin: 0px;' />";
