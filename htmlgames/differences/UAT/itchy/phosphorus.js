  ...
  Stage.prototype.showList = function(name) {
	...
	if (o_list.length) {
	  ...
	  if (info[1] + info[3] < 360) { // !offscreen
	    ...
	    // old way...	
	    divItem2.innerHTML = "<div style='font-size: 11em; text-align: center;'><br><br>(empty)</div><div style='font-size: 11em; text-align: center; padding-bottom: 2em'>length: 0</div>";
	  }
	}
