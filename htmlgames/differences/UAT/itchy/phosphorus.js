...
// qtest
		...
		divItem = document.createElement('div');
		divItem.innerHTML = "<p style='padding-top: 86%'><p style='font-size: 11em; text-align: center;'>(empty)</p></p><div style='padding-top: 86%; font-size: 11em; text-align: center; padding-bottom: 2em'>length: 0</div>"; // 
