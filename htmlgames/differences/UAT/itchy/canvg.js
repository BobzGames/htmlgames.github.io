	...
	function build(opts) {
		...
		svg.init = function(ctx) {
			...
			svg.ViewPort = new (function () {
				...
				this.width = function() { return (this.Current() && this.Current().width) ? this.Current().width : 480; } // pf 480
				this.height = function() { return (this.Current() && this.Current().height) ? this.Current().height : 360; } // pf 360
