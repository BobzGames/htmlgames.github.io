// additional bugfixes by PF. Please visit: goo.gl/zI6A (v0.048)
var that; // PF
...
P.compile = (function() {
  ...
  var compileListener = function(object, script) {
    ...
    var compile = function(block) {
      ...
      } else if (['forward:', '_gotoX:y:', 'gotoSpriteOrMouse:', 'changeXposBy:', 'xpos:', 'changeYposBy:', 'ypos:', 'bounceOffEdge', 'glideSecs:toX:y:elapsed:from:'].indexOf(block[0]) !== -1) {
