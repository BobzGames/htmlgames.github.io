...
var led = (function() {
	...
	var writeMessageToBuffer = function(msg) {
		...
		for (var i =0; i < msg.length; i++) {
			...
			ch = ch.replace(/[^a-zA-Z0-9\s\()?$-=!:.,;%@/+]/g,"");	//drop everything that is not lowercase char or space.
