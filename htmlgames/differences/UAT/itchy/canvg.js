	...
	function build(opts) {
		...
		svg.init = function(ctx) {
			...
			svg.ViewPort = new (function () {
				...
				this.width = function() { return (this.Current() && this.Current().width && (this.Current().width < 480)) ? this.Current().width : 480; } // pf
				this.height = function() { return (this.Current() && this.Current().height && (this.Current().height < 360)) ? this.Current().height : 360; } // pf
		...
		svg.Element.pattern = function(node) {
			...
			this.createPattern = function(ctx, element) {
				...
				//cctx.imageSmoothingEnabled = false; // PF
		...
		svg.Element.GradientBase = function(node) {
			...
			this.createGradient = function(ctx, element, parentOpacityProp) {
				...
				if (this.attribute('gradientTransform').hasValue()) {
					...
					//tempCtx.imageSmoothingEnabled = false; // PF
					tempCtx.fillStyle = g;
		...
		svg.Element.mask = function(node) {
			...
			this.apply = function(ctx, element) {
				...
				element.attribute('mask').value = '';
					...
					//maskCtx.imageSmoothingEnabled = false; // PF
