	...
	function build(opts) {
		...
		svg.init = function(ctx) {
			...
			svg.ViewPort = new (function () {
				...
				this.width = function() { return (this.Current() && this.Current().width) ? this.Current().width%480 : 480; } // pf
				this.height = function() { return (this.Current() && this.Current().height) ? this.Current().height%360 : 360; } // pf
