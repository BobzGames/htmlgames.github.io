// additional bugfixes by PF. Please visit: goo.gl/zI6A (v0.049)
var that; // PF
...
P.compile = (function() {
  ...
  var compileListener = function(object, script) {
    ...
    var compile = function(block) {
      ...
      } else if (['showBackground:', 'startScene', 'nextBackground', 'nextScene', 'startSceneAndWait', 'show', 'hide', '_putPenDown', 'stampCostume', 'showVariable:', 'hideVariable:', 'doAsk', 'setVolumeTo:', 'changeVolumeBy:', 'setTempoTo:', 'changeTempoBy:'].indexOf(block[0]) !== -1) {
          source += 'VISUAL = true;\n'; // 1 0
