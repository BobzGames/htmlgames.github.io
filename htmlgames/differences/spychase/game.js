...
//debugger;
	...
	//{
		...
		//if(navigator.userAgent.match("MSIE"))G_vmlCanvasManager.initElement(g.canvas);
...
function moveSpyCar()
{
	...
	writeText(Math.round(g.roadspeed*5)+"MPH",230,24,18);
};
...
function updateScore()
{
	...
	//{
		...
		if (m.player.score > m.player.hiscore) 
		{
			...
			try{localStorage.setItem("spychase-hiscore", m.player.hiscore);}catch(e){}
		}
